...
class wizard_product_rm_issue(osv.osv_memory):
	_name = "wizard.product.rm.issue"
	_description = "Product Raw Material Issue"
	_columns = {
	...
	def export_excel(self, cr, uid, ids, context=None):
		...
		return {
				...
				'report_name': 'stock.rm.issue.xls',
				'report_type': 'xls',
				'datas': datas,
				}
wizard_product_rm_issue()