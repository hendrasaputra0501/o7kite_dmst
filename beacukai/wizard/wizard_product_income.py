...
class wizard_product_income(osv.osv_memory):
	_name = "wizard.product.income"
	_description = "Product income"
	_columns = {
	...
	def action_open_window(self, cr, uid, ids, context=None):
		...
		if wizard:
			...
			result = data_obj._get_id(cr, uid, 'beacukai', 'view_beacukai_document_line_in_tree')
